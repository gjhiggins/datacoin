...
UniValue validateaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("validateaddress", "\"DDqueAuaKascEfAkS5xzp6eX1GBuVPAoGu\"")
            + HelpExampleRpc("validateaddress", "\"DDqueAuaKascEfAkS5xzp6eX1GBuVPAoGu\"")
        );
...
UniValue verifymessage(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 3)
        throw std::runtime_error(
            ...
            + HelpExampleCli("signmessage", "\"DDqueAuaKascEfAkS5xzp6eX1GBuVPAoGu\" \"my message\"") +
            "\nVerify the signature\n"
            + HelpExampleCli("verifymessage", "\"DDqueAuaKascEfAkS5xzp6eX1GBuVPAoGu\" \"signature\" \"my message\"") +
            "\nAs json rpc\n"
            + HelpExampleRpc("verifymessage", "\"DDqueAuaKascEfAkS5xzp6eX1GBuVPAoGu\", \"signature\", \"my message\"")
        );
